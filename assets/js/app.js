...
$(document).on('click', '.bookInfo', function(){
  ...
  // look into $this elements rating which we stored when we madehtml
  // var ratingNumber = $this.data('stars');
  // var ratingStars = "http://sometnig.or.other.assets/images/" + ratingNumber +".jpg"
